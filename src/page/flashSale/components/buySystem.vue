<template>
    <div>
        ...
        <addressCheck @submitAddress="selectedAddress" :addressShow="addressShow" :data="goodsData" :spec_id='spec_id' :setDefault="false"></addressCheck>
        <prompt :promptObj="promptObj" :goodsData='goodsData' :spec_id='spec_id'></prompt>
    </div>
</template>
