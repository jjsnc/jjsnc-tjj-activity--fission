...
<template>
	<div class="addressCheck">
		...
		<newAddress @postNewAddr="postNewAddr" :newAddrShow="newAddrShow" :goodSData='data' :spec_id='spec_id'></newAddress>
...
import { getAddressList, editAddress } from "@/assets/js/common/commonApi.js";
export default {
	name: "addressCheck",
	components: {
		slideUpBox,
	...
	methods: {
		...
		//         if(this.checkedSkus[i] == undefined || this.checkedSkus[i] == null){
