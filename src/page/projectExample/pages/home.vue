            ...
            danmuData: [
                {
                    ...
                    time: 28,
                    user: "七墓凉",
                    userIcon: "http://tjjimg.taojiji.com/group/userIcon/1128.jpg"
                },
                {
                    price: 43,
                    time: 57,
                    user: "钓一江月",
                    userIcon: "http://tjjimg.taojiji.com/group/userIcon/1485.jpg"
                },
                {
                    price: 34,
                    time: 35,
                    user: "?個榶衯唡姅",
                    userIcon: "http://tjjimg.taojiji.com/group/userIcon/1386.jpg"
                }
            ]
        };
    },
