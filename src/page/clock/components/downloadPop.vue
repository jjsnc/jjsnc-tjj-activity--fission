<template>
    <div class="wrap-model">
        <div
            :class="['model', downloadPopShow ? 'model-show' : '']"
            @click.self.stop="closeModel()"
        >
            <div class="model-cont">
                ...
                <div class="logo">
                    <img src="../assets/images/icon111@2x.png" alt>
                </div>
                <div class="main">
                    ...
                    <div class="img-wrap">
                        ...
                        <p class="down-text">快去应用商店下载App，打卡全额返!</p>
                        <!-- <img width="160" height="60" src="../assets/images/icon_3y@3x.png"> -->
                    </div>
                    <a class="btn" @click="down()">我知道啦</a>
                </div>
            </div>
        </div>
    </div>
