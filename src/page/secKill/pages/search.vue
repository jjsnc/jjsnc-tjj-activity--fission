...
<template>
    <div class="secKill-list">
        <div class="seach-box">
            <form action="" @submit.prevent="searchFn">
                <input ref='searchInput' type="search" autofocus placeholder="请输入商品名称" @blur="blur" v-model="searchTxt">
            </form>
        </div>
...
<script>
    ...
    import {tgMsGoodsList} from './../assets/js/api.js'
            ...
            getData(){
                ...
                this.$http.get(tgMsGoodsList, {params}).then((res) => {
                    ...
                    if(data && data.result == 1){
                        ...
                        this.msgTxt = (res && res.data && res.message) || '商品列表请求失败'
                    }
                })
            },
            loadMore(){
