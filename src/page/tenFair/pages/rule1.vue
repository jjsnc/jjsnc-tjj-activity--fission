<template>
	<div :class="['rule', ruleShow ? 'rule-show' : '']" @click.self.stop="closeRule()">
		<div class="rule-cont">
			...
			<div class="r-c-title">十元两件集市规则</div>
			<div class="r-c-con">
				<p>1、用户可以随意选择一家
					<span class="red">10元2件</span>集市中的店铺，在店铺挑选
					<span class="red">2件</span>商品，即可享受
					<span class="red">10元</span>包邮到家的优惠。
				</p>
				<p>2、必须为同一家店铺的
					<span class="red">2件</span>商品，不支持跨店选择。如选择的商品不足
					<span class="red">2件</span>，会按照每件商品的价格单独计算订单金额。
				</p>
				<p>3、订单支付后可前往我的订单查看物流详情。</p>
				<p>4、
					<span class="red">10元2件</span>订单，在商品发货前取消单件商品会导致此订单全部取消。
				</p>
